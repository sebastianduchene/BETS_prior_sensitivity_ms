...
\textcolor{red}{
\begin{itemize}
	\item[1] Our study demonstrates that the choice of prior has an impact in model selection, and can result in incorrectly selecting models for the purpose of detecting temporal signal and choosing molecular clocks.
