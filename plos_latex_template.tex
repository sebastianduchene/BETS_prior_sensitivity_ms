...
\begin{figure}[!h]
	\begin{center}
		...
		\vspace{-0.5cm}
		\caption{\textbf{Densities of key statistics of \textit{Powassan virus} empirical data under.} The clock rate, root height, tree length, and coefficient of rate variation are shown under three priors on $\theta$, exponential (red), gamma (blue), and lognormal (green).}
	\end{center}
\end{figure}
\begin{figure}[!h]
	\begin{center}
